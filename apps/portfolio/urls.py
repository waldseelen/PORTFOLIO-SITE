...
from . import views
from .feeds import CombinedFeed, LatestPostsFeed, LatestProjectsFeed
...
urlpatterns = [
    ...
    path(
        ...
        views.csp_violation_report,
        name="csp_violation_report",
    ),
    path(
        "api/security/network-error-report/",
        views.network_error_report,
        name="network_error_report",
    ),
    # HTMX API Endpoints
    path(
        "api/htmx/like/<int:project_id>/",
        views.like_project,
        name="like_project",
    ),
    path(
        "api/htmx/project/<int:project_id>/description/",
        views.project_description,
        name="project_description",
    ),
    path(
        "api/htmx/projects/filter/",
        views.filter_projects,
        name="filter_projects",
    ),
    path(
        "api/htmx/projects/search/",
        views.search_projects,
        name="search_projects",
    ),
    path(
        "api/htmx/projects/load-more/",
        views.load_more_projects,
        name="load_more_projects",
    ),
    # RSS Feeds
