...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        broker_url = options["broker"] or getattr(
        ...
        self.stdout.write(
            "Access the monitoring dashboard at: http://{}:{}".format(
        ...
        try:
            ...
            cmd = [
                ...
                "--db",
                "flower.db",  # Database file for persistence
            ]
            ...
            self.stdout.write(self.style.ERROR(f"Error starting Flower: {e}"))
            raise
